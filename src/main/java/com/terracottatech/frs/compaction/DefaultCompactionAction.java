 ...
 * @author prasa
 */
class DefaultCompactionAction extends PutAction implements CompactionAction {
  private final ObjectManagerEntry<ByteBuffer, ByteBuffer, ByteBuffer> entry;
  private final ObjectManager<ByteBuffer, ByteBuffer, ByteBuffer> objectManager;

  private volatile Long lsn;

  DefaultCompactionAction(ObjectManager<ByteBuffer, ByteBuffer, ByteBuffer> objectManager,
