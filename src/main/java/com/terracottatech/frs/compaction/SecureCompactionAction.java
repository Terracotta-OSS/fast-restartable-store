 ...
 * @author prasanta
 */
public class SecureCompactionAction extends SecurePutAction implements CompactionAction {
  private final ObjectManagerEntry<ByteBuffer, ByteBuffer, ByteBuffer> entry;
  private final ObjectManager<ByteBuffer, ByteBuffer, ByteBuffer> objectManager;

  private volatile Long lsn;

  SecureCompactionAction(ObjectManager<ByteBuffer, ByteBuffer, ByteBuffer> objectManager,
    ObjectManagerEntry<ByteBuffer, ByteBuffer, ByteBuffer> entry, CipherManager cipherManager) {
    super(objectManager, null, cipherManager, entry.getId(), entry.getKey(), entry.getValue(), entry.getLsn());
